...
using WONDERLUST_PROJECT_APIs.Helpers;
using Microsoft.OpenApi.Models;
using WONDERLUST_PROJECT_APIs.Filters;
...
{
    option.SwaggerDoc("v1", new OpenApiInfo { Title = "WONDERLUST_PROJECT_APIs", Version = "v1" });
